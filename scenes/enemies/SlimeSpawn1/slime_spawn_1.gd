...
@export var growl_min_interval: float = 3.5
@export var growl_max_interval: float = 5.0
...
func _ready():
	...
	sounds = {
		"growl": preload("res://assets/audio/sfx/AleteoSFX.mp3")
	}
	super._ready()
