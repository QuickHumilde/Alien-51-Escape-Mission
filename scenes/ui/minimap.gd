...
# FIX: variable para mostrar mapa completo
...
func _ready() -> void:
	...
	Signals.show_full_map.connect(_on_show_full_map)

func _on_death():
	self.hide()

func _on_show_full_map():
	_show_full_map = !_show_full_map
	queue_redraw()
...
func _build_visible_keys() -> Dictionary:
	...
	# FIX: si _show_full_map es true, mostrar TODAS las salas
	if _show_full_map:
